...
/* USB Device Info */
#define DEF_USB_VID                   0x534B
#define DEF_USB_PID                   0x10A0
...
#define DEF_USBD_REPORT_DESC_LEN_KB   0x35
#define DEF_USBD_REPORT_DESC_LEN_MS   0x34
#define DEF_USBD_REPORT_DESC_LEN_MD   0x50
...
extern const uint8_t MediaRepDesc[ ];
